package com.example.helenmiller.alohamusic;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mpUkulele = MediaPlayer.create(this, R.raw.ukulele); // create media player that only pays uke file
        mpDrums = new MediaPlayer();
        mpDrums = MediaPlayer.create(this, R.raw.drums);// create media player that only pays drums file
